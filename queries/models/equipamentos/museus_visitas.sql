WITH museus AS (
  ...
  FROM `rj-setur.turismo_fluxo_visitantes_staging.museu_acude`    
  ...
  FROM `rj-setur.turismo_fluxo_visitantes_staging.museu_republica`      
  ...
  FROM `rj-setur.turismo_fluxo_visitantes_staging.museu_villa_lobos`    
  ...
  SELECT
    ...
    SAFE_CAST(SAFE_CAST(no_visitantes as FLOAT64) as INT64) as metrica_valor,
    "numero_visitantes" as metrica_tipo,
    "Museu Histórico Nacional" as ferramenta_turistica 
  FROM `rj-setur.turismo_fluxo_visitantes_staging.museu_nacional`    
  ...
  FROM `rj-setur.turismo_fluxo_visitantes_staging.museu_chacara_do_ceu`
),
