  ...
  FROM `rj-setur.turismo_fluxo_visitantes_staging.aquario`
  ...
  FROM `rj-setur.turismo_fluxo_visitantes_staging.bio_parque`
  ...
  FROM `rj-setur.turismo_fluxo_visitantes_staging.ccbb`
  ...
  FROM `rj-setur.turismo_fluxo_visitantes_staging.cristo_redentor`
  ...
  FROM `rj-setur.turismo_fluxo_visitantes_staging.museu_do_amanha`
  ...
  FROM `rj-setur.turismo_fluxo_visitantes_staging.pao_de_acucar`
